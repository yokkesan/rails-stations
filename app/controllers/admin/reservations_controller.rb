class Admin::ReservationsController < ApplicationController
    ...
    def update
      if Reservation.where.not(id: @reservation.id).exists?(schedule_id: reservation_params[:schedule_id], sheet_id: reservation_params[:sheet_id], date: reservation_params[:date])
